package com.revia.unitconverter
...
import com.revia.unitconverter.ui.theme.UnitConverterTheme
    ...
    Column(
        ...
        Row {
            Box {
                Button(onClick = { /*TODO*/ }) {
                    Text(text = "Select")
                    Image(Icons.Default.ArrowDropDown, contentDescription = "Arrow Down")
                }
